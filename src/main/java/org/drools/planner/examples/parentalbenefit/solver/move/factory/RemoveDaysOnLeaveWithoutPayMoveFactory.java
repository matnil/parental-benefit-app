...
public class RemoveDaysOnLeaveWithoutPayMoveFactory extends AbstractMoveFactory {
    ...
    public List<Move> createMoveList(@SuppressWarnings("rawtypes") Solution solution) {
        ...
        for (ListIterator<MonthPlan> iter = monthPlanList.listIterator(); iter.hasNext();) {
            ...
            if (monthPlan.getDaysOnLeaveWithoutPay() > 0) {
            	// replace one day at home without pay with one day at work
